import { z } from 'zod';
import { T_NODE_FILTERS_GROUPS_MAP, z_node_filters, z_node_filters_groups_map } from './filter';


export const z_query_params_sort = z.record(
    z.union([
        z.literal("ASC"), 
        z.literal("DESC")
    ])
...
export const z_query_params_level_1 = z.object({
    qid: z.string(), // when we don't have direct id but we have conditions we need to use a query id. To subscribe 
    type: z.literal("QP_LEVEL1"),
    static_filters: z_node_filters_groups_map,
    filters: z_node_filters_groups_map,
...
export type T_QUERY_PARAMS_LEVEL_1 = z.infer<typeof z_query_params_level_1>;
...
export const z_query_params_code = z.object({
    ...
    filters: z_node_filters.optional(),
    search: z_query_params_search.optional(),
    sorts: z_query_params_sorts.optional(),
    limit: z.number().default(16),
    cursor: z.object({
